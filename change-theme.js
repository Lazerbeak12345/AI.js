...
function changeThemeTo(theme) {
	$("."+localStorage.style+"-theme").parent().removeClass("active").attr("title","");//remove from old class
	localStorage.style=theme;
	$("#theme").prop('disabled',true).prop('href',themes[theme]).prop('disabled',false);//change theme
	$("."+theme+"-theme").parent().addClass("active").attr("title","Current");//add to new class
}
